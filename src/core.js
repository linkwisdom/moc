...
exports.config = function (config) {
    ...
    if (config && config.dir) {
        // 当前扫描开始
        exports.emit('scan-start', config);
...
exports.getContext = function (request, response) {
    ...
    if (!context.path) {
        ...
        exports.emit('query-miss', request);
    }
...
exports.serve = function (request, response) {
    exports.emit('query-start', request);

    var context = exports.getContext(request, response);

    exports.emit('query-ready', context);
    ...
    exports.emit('response-start', result);
    ...
    // exports.emit('response-end', result);
};